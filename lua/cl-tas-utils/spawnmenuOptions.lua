...
function TASUtils.OptionsMenu(optionsPanel)

    local dj_checkbox = vgui.Create("DCheckBoxLabel")
...
hook.Add("PopulateToolMenu","AddTASOptionsCategory",function()
    spawnmenu.AddToolMenuOption("Options","TAS Options","TAS.MenuSettings","Settings","","",TASUtils.OptionsMenu, {
